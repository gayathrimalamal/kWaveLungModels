%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Normal lung model - Presence of A-lines
% Script for simulating a normal lung model using k-Wave toolbox for PW
% transmissions. 
