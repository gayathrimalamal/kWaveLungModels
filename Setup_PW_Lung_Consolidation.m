%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Abnormal lung model - Subpleural Consolidations
% Script for simulating an lung with subpleural consolidations using
% k-Wave toolbox for PW transmissions. 
...
addpath(genpath(pwd));
filepath = pwd;
dataset_name = 'Lung_Consolidation';
...
Trans.angles = 0;%linspace(-18,18,7);     % Steering angle of the transmit signal between [-18, +18] [degrees]
...
for Nc = 1: Trans.tx_N_elements
    karray.addRectElement([kgrid.x_vec(1), probe_geometry(Nc, 1)], dx, Trans.tx_element_width, rotation);
end
